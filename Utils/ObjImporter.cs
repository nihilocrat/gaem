...
{ 
	...
	public Mesh ImportFile (string filePath)
    {
        ...
        meshStruct newMesh = createMeshStruct(filePath, entireText);
         ...
         */
        for (int j = 0; j < newMesh.faceData.Length; j++)
        {
            Vector3 v = newMesh.faceData[j];
        ...
        // HACK TODO : limit of 65000 verts on meshes according to Unity ... change this if that limit changes
